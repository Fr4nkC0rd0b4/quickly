    			...
    			<div class="card">
    				<div class="card-body">
    					<form method="POST" id="form">
                            <input type="hidden" name="id" :value="payment.user_id">
    						<div class="form-group">
    							<label for="name" class="">Nombres</label>
    							<input name="name" required type="text" class="is-untouched is-pristine av-invalid form-control" :value="payment.name_owner">
    						</div>
                            <div class="form-group">
                                <label for="dni" class="">Cédula</label>
                                <input name="dni" required type="text" class="is-untouched is-pristine av-invalid form-control" :value="payment.last_name_owner">
                            </div>
    						<div class="form-group">
    							...
    							<div class="input-group">
    								...
    								<input placeholder="Correo" name="email" required id="email" type="text" class="is-untouched is-pristine av-invalid form-control" :value="payment.card_type">
