                                    ...
                                    @foreach ($menus as $key => $menu_item)
                                        <li class="side-nav-item">
                                            ...
                                            @if ($menu_item->link() == '/home')
                                                <router-link
                                                    to="{{ $menu_item->link() !== '' ? $menu_item->link() : '' }}">
                                            ...
                                            @elseif (substr($menu_item->link(), 0, 5) == '/spa/')
                                                ...
                                                {{-- Rutas normales --}}
                                            @else
                                                <a href="{{ $menu_item->link() !== '' ? $menu_item->link() : 'javascript: void(0);' }}"
                                                    class="side-nav-link" aria-expanded="false"
                                            ...
                                            {{-- Menu desplegable --}}
                                            @if (count($menu_item->children) > 0)
                                                <ul class="side-nav-second-level mm-collapse">
                                                    @foreach ($menu_item->children as $children)
                                                        <li>
                                                            @if (substr($children->link(), 0, 5) == '/spa/')
